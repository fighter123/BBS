  ...
  <body>
    <center>
      ...
      <table border="1" width="99%" cellspacing="0" cellpadding="0" bordercolor="#E3E3E3" bordercolorlight="#E0E0E0" bordercolordark="white" rules="all" style="margin-top:8;word-break:break-all">
          ...
          <tr height="130"><td colspan="2" valign="top" style="padding-top:6;padding-left:6;padding-right:6;padding-bottom:6"><bean:write name="bbsRootSingle" property="bbsContent" scope="session" filter="false"/><br>
          <c:if test="${sessionScope.bbsRootSingle.vsrc!=''}">
          <a href="media_player.jsp?id=${sessionScope.bbsRootSingle.vsrc}"><img src="<%=basePath%>${sessionScope.bbsRootSingle.pic}" width="140" height="100"/> </a>
          </c:if>
          </tr>
