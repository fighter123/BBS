...
public interface MediaDao {
     ...
     * @throws Exception
     */
    public boolean saveMedia(TbMedia media)throws Exception;
     ...
     * @return
     */
    public List<TbMedia> queryALlMedia(int firstResult, int maxResult)throws Exception;
     ...
     * @throws Exception
     */
    public TbMedia queryMediaById(int id)throws Exception;
}
